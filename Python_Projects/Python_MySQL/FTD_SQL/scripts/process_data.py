...
def _process_string_for_sql(string):
...
def process_country(data_folder, output_folder):
    ...
    country_pipe_route = output_folder
    pairs = [
        [1, 4],
        [5, 11],
        [12, 60]
...
def process_district(data_folder, output_folder):
    ...
    district_pipe_route = output_folder
    pairs = [
        [1, 2],
        [3, 9],
        [10, 59]
...
def process_enduse(data_folder, output_folder):
    ...
    enduse_pipe_route = output_folder
    pairs = [
        [1, 5],
        [6, 105]
    ]
...
def process_exp_comm(data_folder, output_folder):
    ...
    exp_comm_pipe_route = output_folder
    pairs = [
        [1, 1],
        [2, 11],
        [12, 61],
...
def process_exp_cty(data_folder, output_folder):
    ...
    exp_cty_pipe_route = output_folder
    pairs = [
        [1, 4],
        [5, 34],
        [35, 38],
...
def process_exp_detl(data_folder, output_folder):
    ...
    exp_detl_pipe_route = output_folder
    pairs = [
        [1, 1],
        [2, 11],
        [12, 15],
...
def process_exp_dist(data_folder, output_folder):
    ...
    exp_dist_pipe_route = output_folder
    pairs = [
        [1, 2],
        [3, 32],
        [33, 36],
...
def process_hitech(data_folder, output_folder):
    ...
    hitech_pipe_route = output_folder
    pairs = [
        [1, 2],
        [3, 32]
    ]
...
def process_hsdesc(data_folder, output_folder):
    ...
    hsdesc_pipe_route = output_folder
    pairs = [
        [1, 6],
        [7, 156],
        [157, 206]
...
def process_naics(data_folder, output_folder):
    ...
    naics_pipe_route = output_folder
    pairs = [
        [1, 6],
        [7, 56]
    ]
...
def process_imp_comm(data_folder, output_folder):
    ...
    imp_comm_pipe_route = output_folder
    pairs = [
        [1, 10],
        [11, 60],
        [61, 63],
...
def process_imp_cty(data_folder, output_folder):
    ...
    imp_cty_pipe_route = output_folder
    pairs = [
        [1, 4],
        [5, 34],
        [35, 38],
...
def process_imp_de(data_folder, output_folder):
    ...
    imp_de_pipe_route = output_folder
    pairs = [
        [1, 2],
        [3, 32],
        [33, 36],
...
def process_imp_du(data_folder, output_folder):
    ...
    imp_du_pipe_route = output_folder
    pairs = [
        [1, 2],
        [3, 32],
        [33, 36],
...
def process_imp_detl(data_folder, output_folder):
    ...
    imp_detl_pipe_route = output_folder
    pairs = [
        [1, 10],
        [11, 14],
        [15, 16],
...
def process_STHS6(data_folder, output_folder, date):
    ...
    STHS6_pipe_route = output_folder
    pairs = [
        [1, 6],
        [7, 10],
        [11, 12],
...
def process_STNAICS(data_folder, output_folder, date):
    ...
    STNAICS_pipe_route = output_folder
    pairs = [
        [1, 4],
        [5, 8],
        [9, 10],
...
def process_ISTHS6(data_folder, output_folder, date):
    ...
    ISTHS6_pipe_route = output_folder
    pairs = [
        [1, 6],
        [7, 10],
        [11, 12],
...
def process_ISTNAICS(data_folder, output_folder, date):
    ...
    ISTNAICS_pipe_route = output_folder
    pairs = [
        [1, 4],
        [5, 8],
        [9, 10],
...
def process_DPORTHS6E(data_folder, output_folder, date):
    ...
    DPORTHS6E_pipe_route = output_folder
    pairs = [
        [1, 6],
        [7, 10],
        [11, 14],
...
def process_DPORTHS6I(data_folder, output_folder, date):
    ...
    DPORTHS6I_pipe_route = output_folder
    pairs = [
        [1, 6],
        [7, 10],
        [11, 14],
