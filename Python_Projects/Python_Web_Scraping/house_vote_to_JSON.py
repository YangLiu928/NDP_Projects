    ...
    while session_number < 3:
        ...
        while True:
            try:
                ...
                bs_object = BeautifulSoup(response.read(), 'html.parser')
                ...
                if re.search('404', bs_object.head.title.contents[0]):
                    break
                table_rows = bs_object.find_all('tr')
                ...
                for table_row in table_rows[1:]:
                    ...
                    if table_data[2].font.a is not None:
