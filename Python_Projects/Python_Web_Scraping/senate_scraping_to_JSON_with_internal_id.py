    ...
    while session_number < 3:
        ...
        while True:
            try:
                ...
                dict['ids'] = {'internal_id': internal_ids[0], 'amendment_to_id': internal_ids[1]}
                vote_number += 1
                dicts.append(dict)
...
def _get_internal_ids(dict):
    try:
        if dict['roll_call_vote']['amendment']['amendment_number'] != None:
        ...
        elif re.search('[S.,H.]J.Res.', dict['roll_call_vote']['document']['document_name']):
...
if __name__ == '__main__':
    ...
    with open('internal_ids.JSON', 'w') as outfile:
